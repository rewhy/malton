...
Bool   VG_(clo_trace_syscalls) = True; // Rewhy
Bool   VG_(clo_trace_signals)  = False;
Bool   VG_(clo_trace_symtab)   = True; // Rewhy
const HChar* VG_(clo_trace_symtab_patt) = "*";
Bool   VG_(clo_trace_cfi)      = False;
Bool   VG_(clo_debug_dump_syms) = True; // Rewhy
Bool   VG_(clo_debug_dump_line) = False;
Bool   VG_(clo_debug_dump_frames) = False;
Bool   VG_(clo_trace_redir)    = True; // Rewhy
enum FairSchedType
       VG_(clo_fair_sched)     = disable_fair_sched;
Bool   VG_(clo_trace_sched)    = True; // Rewhy
...
Bool   VG_(clo_sym_offsets)    = True; // Rewhy
...
Bool   VG_(clo_track_fds)      = True; // Rewhy
