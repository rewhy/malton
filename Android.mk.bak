...
# Build malton-$(TARGET_ARCH)-linux
vg_local_module := malton
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	...
	malton/dt_taint.c \
	malton/dt_stmt2.c \
	malton/dt_sys_wrap.c \
	malton/dt_mem_wrap.c \
	malton/dt_instrument.c \
	malton/dt_dexparse.c \
	malton/dt_oatparse.c \
	malton/dt_framework.c \
	malton/copy.c
...
# Build vgpreload_malton-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_malton
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	malton/dt_libfun_replace.c
...
# Build packergrind-$(TARGET_ARCH)-linux
vg_local_module := packergrind
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	packergrind/pg_main.c \
	packergrind/pg_stmt.c \
	packergrind/pg_syswrap.c \
	packergrind/pg_mthtrace.c \
	packergrind/pg_memtrace.c \
	packergrind/pg_framework.c \
	packergrind/pg_translate.c \
	packergrind/pg_mem_wrappers.c \
	packergrind/pg_copy.c \
	packergrind/pg_oatparse.c \
	packergrind/pg_dexparse.c
...
# Build vgpreload_packergrind-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_packergrind
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	packergrind/pg_replace_wrapper.c
...
# Build deobfuscator-$(TARGET_ARCH)-linux
vg_local_module := deobfuscator
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := EXECUTABLE
...
vg_local_src_files := \
	deobfuscator/do_main.c \
	deobfuscator/shadow_memory.c \
	deobfuscator/symbolic_execution.c \
	deobfuscator/taint_analysis.c \
	deobfuscator/util.c \
	deobfuscator/copy.c \
	deobfuscator/do_mem_replace.c \
	deobfuscator/do_dexparse.c \
	deobfuscator/do_oatparse.c \
	deobfuscator/do_framework.c \
	deobfuscator/do_instrument.c \
	deobfuscator/do_syswrap.c
...
# Build vgpreload_deobfuscator-$(TARGET_ARCH)-linux.so
vg_local_module := vgpreload_deobfuscator
vg_local_module_class := SHARED_LIBRARIES
vg_local_target := SHARED_LIBRARY
vg_local_no_crt := true

vg_local_src_files := \
	deobfuscator/do_lib_wrapper.c
